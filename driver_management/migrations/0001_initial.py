<<<<<<< HEAD
# Generated by Django 4.2.1 on 2024-03-09 05:18
=======
# Generated by Django 4.2.1 on 2024-03-05 13:47
>>>>>>> d2e46aad92e4733b51d4259f10c9d4ff39ae917e
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driving_status', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('scheme_type', models.CharField(blank=True, choices=[('Platinum', 'Platinum'), ('Gold', 'Gold'), ('Silver', 'Silver'), ('Diwali', 'Diwali'), ('Gold2', 'Gold2'), ('Platinum2', 'Platinum2'), ('Bronze', 'Bronze')], max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('driver_name1', models.CharField(blank=True, max_length=100, null=True)),
                ('driver_mobile', models.CharField(blank=True, max_length=100, null=True)),
                ('package', models.CharField(blank=True, choices=[('Gold', 'Gold'), ('Gold2', 'Gold2'), ('Platinium', 'Platinium'), ('Platinium2', 'Platinium2'), ('Bronze', 'Bronze'), ('silver', 'silver'), ('DiwaliScheme', 'DiwaliScheme')], max_length=100, null=True)),
                ('paymentamount', models.BigIntegerField(blank=True, null=True)),
                ('tax_amount', models.BigIntegerField(blank=True, null=True)),
                ('total_amount_paid', models.BigIntegerField(blank=True, null=True)),
                ...
                ('package_booking_type', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('driverusername', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='adddriver',
            name='driver_app_status_new',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='driver_management.driverappstatus'),
        ),
        migrations.AddField(
            model_name='adddriver',
            name='driver_user',
        ...
        migrations.AddField(
            model_name='adddriver',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_master.location'),
        ),
        migrations.AddField(
            model_name='adddriver',
            name='state',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_master.state'),
        ),
        migrations.AddField(
            model_name='adddriver',
            name='zone',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_master.zone'),
        ),
    ]

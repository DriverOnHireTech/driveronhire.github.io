# Generated by Django 4.2.1 on 2023-10-24 12:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('drivername', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='BgVerification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_company_name', models.CharField(blank=True, max_length=15, null=True)),
                ('transmission_type', models.CharField(blank=True, choices=[('Manual', 'Manual'), ('Automatic', 'Automatic'), ('Luxury', 'Luxury'), ('All', 'All')], max_length=10, null=True)),
                ('car_type', models.CharField(blank=True, choices=[('SUV', 'SUV'), ('Sedan', 'Sedan'), ('Luxury', 'Luxury'), ('Hatchback', 'Hatchback'), ('MPV', 'MPV'), ('MUV', 'MUV')], max_length=10, null=True)),
                ...
                ('scheme_type', models.CharField(blank=True, choices=[('Platinum', 'Platinum'), ('Gold', 'Gold'), ('Silver', 'Silver')], max_length=10, null=True)),
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_master.city')),
                ('driver_app_status', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='driver_management.driverappstatus')),

...
=======
# Generated by Django 4.2.1 on 2023-10-11 05:48
>>>>>>> 30fd9b5b7855563eb504844e7be49e6787158499
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedual_booking_time', models.DateTimeField(blank=True, null=True)),
                ...
                ('driver_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='driver_name', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
